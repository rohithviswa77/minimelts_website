...
const tshirtHero = '/assets/pages/TShirts/tshirt-hero-bw.png';
        ...
        <header className={`${theme.spacing.containerWidth} py-16 px-6 md:px-8`}>
          <div className="text-left">
            ...
            <h1 className="text-4xl md:text-5xl font-serif text-brand-charcoal leading-tight">
              Custom T-Shirts <br/>
              <span className="italic font-normal text-brand-sage">your style, your way</span>
            </h1>
            <p className="mt-4 text-gray-400 font-light max-w-md">
              Versatile and comfortable T-shirts for all ages.
            </p>
          </div>
        </header>
